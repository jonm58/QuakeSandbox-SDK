...
void SandboxMain_MenuInit( void ) {
	...
	s_sandboxmain.classlist.numitems		= 123;
...
if(uis.sb_tab == 10){	
	...
	s_sandboxmain.classlist.itemnames[82] = "target_clientcmd";
	s_sandboxmain.classlist.itemnames[83] = "target_laser";
	s_sandboxmain.classlist.itemnames[84] = "target_score";
	s_sandboxmain.classlist.itemnames[85] = "target_clienttarg";
	s_sandboxmain.classlist.itemnames[86] = "target_cmd";
	s_sandboxmain.classlist.itemnames[87] = "target_music";
	s_sandboxmain.classlist.itemnames[88] = "target_sound";
	s_sandboxmain.classlist.itemnames[89] = "target_model";
	s_sandboxmain.classlist.itemnames[90] = "target_legs";
	s_sandboxmain.classlist.itemnames[91] = "target_head";
	s_sandboxmain.classlist.itemnames[92] = "target_teleporter";
	s_sandboxmain.classlist.itemnames[93] = "target_relay";
	s_sandboxmain.classlist.itemnames[94] = "target_kill";
	s_sandboxmain.classlist.itemnames[95] = "target_position";
	s_sandboxmain.classlist.itemnames[96] = "target_push";
	s_sandboxmain.classlist.itemnames[97] = "target_logic";
	s_sandboxmain.classlist.itemnames[98] = "target_gravity";
	s_sandboxmain.classlist.itemnames[99] = "target_unlink";
	s_sandboxmain.classlist.itemnames[100] = "target_debrisemitter";
	s_sandboxmain.classlist.itemnames[101] = "target_earthquake";
	s_sandboxmain.classlist.itemnames[102] = "target_effect";
	s_sandboxmain.classlist.itemnames[103] = "target_modify";
	s_sandboxmain.classlist.itemnames[104] = "target_playerstats";
	s_sandboxmain.classlist.itemnames[105] = "target_variable";
	s_sandboxmain.classlist.itemnames[106] = "target_cutscene";
	s_sandboxmain.classlist.itemnames[107] = "target_stats";
	s_sandboxmain.classlist.itemnames[108] = "target_music";
	s_sandboxmain.classlist.itemnames[109] = "misc_teleporter_dest";
	s_sandboxmain.classlist.itemnames[110] = "shooter_rocket";
	s_sandboxmain.classlist.itemnames[111] = "shooter_grenade";
	s_sandboxmain.classlist.itemnames[112] = "shooter_plasma";
	s_sandboxmain.classlist.itemnames[113] = "shooter_bfg";
	s_sandboxmain.classlist.itemnames[114] = "shooter_prox";
	s_sandboxmain.classlist.itemnames[115] = "shooter_flame";
	s_sandboxmain.classlist.itemnames[116] = "shooter_antimatter";
	s_sandboxmain.classlist.itemnames[117] = "shooter_custom";
	s_sandboxmain.classlist.itemnames[118] = "weapon_brick";
	s_sandboxmain.classlist.itemnames[119] = "weapon_diamond";
	s_sandboxmain.classlist.itemnames[120] = "weapon_dirt";
	s_sandboxmain.classlist.itemnames[121] = "weapon_stone";
