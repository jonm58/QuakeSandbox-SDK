...
// all others
#define ID_FREELOOK		55
#define ID_INVERTMOUSE	56
#define ID_ALWAYSRUN	57
#define ID_AUTOSWITCH	58
#define ID_MOUSESPEED	59
#define ID_JOYENABLE	60
#define ID_JOYTHRESHOLD	61
#define ID_SMOOTHMOUSE	62
#define ID_MOUSESTYLE	63
...
static bind_t g_bindingsrus[] = 
{
	...
	{"ui_sandbox", 	"меню песочницы",	ID_SANDBOX,		ANIM_CHAT,		-1,				-1,		-1, -1},
...
static void Controls_DrawKeyBinding( void *self )
{
	...
	if (c)
	{
		...
		UI_DrawString( x - SMALLCHAR_WIDTH, y, g_bindingsrus[a->generic.id].label, UI_RIGHT|UI_SMALLFONT, text_color_highlight );
		}
...
static void Controls_MenuInit( void )
{
	...
	s_controls.vtaunt.generic.type	   = MTYPE_ACTION;
	s_controls.vtaunt.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.vtaunt.generic.callback  = Controls_ActionEvent;
	s_controls.vtaunt.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.vtaunt.generic.id        = ID_VTAUNT;
