...
static imageSource_t quakeImageList[] = {
	{ 150, "menu/art/level_complete4.tga", 1.0, 0, NULL, 0.0, 0 },	// displayed on first pass
	{ 5, "models/players/kyonshi/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/beret/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/sergei/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/assassin/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/skelebot/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/tony/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 5, "models/players/penguin/icon_default.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 30, "menu/medals/medal_gauntlet.tga", 1.0, 1, NULL, 0.0, 0 },
	{ 30, "menu/art/skill4.tga", 1.0, 0, NULL, 0.0, 0 },
	{ 30, "menu/art/level_complete1.tga", 1.0, 0, NULL, 0.0, 0 }
};
...
/*	{ CREDIT_NORMAL|CREDIT_HIGHREVERSETEXT|CREDIT_SHUFFLETEXT,
		id_credits, ARRAY_SIZEOF(id_credits),
		"uie_creditdisc", quakeImageList, ARRAY_SIZEOF(quakeImageList),
		NULL, 0,
