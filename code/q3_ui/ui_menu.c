...
#define CREATEGAME0				"menu/art/creategame_0"
#define CREATEGAME1				"menu/art/creategame_1"
#define FINDGAME0				"menu/art/findgame_0"
#define FINDGAME1				"menu/art/findgame_1"
#define SETTINGS0				"menu/art/settings_0"
#define SETTINGS1				"menu/art/settings_1"
#define DEMOS0				"menu/art/demos_0"
#define DEMOS1				"menu/art/demos_1"
#define GAMES0				"menu/art/games_0"
#define GAMES1				"menu/art/games_1"
#define EXIT0				"menu/art/exit_0"
#define EXIT1				"menu/art/exit_1"
#define CREATEGAME0RU				"menu/art/creategame_0ru"
#define CREATEGAME1RU				"menu/art/creategame_1ru"
#define FINDGAME0RU				"menu/art/findgame_0ru"
#define FINDGAME1RU				"menu/art/findgame_1ru"
#define SETTINGS0RU				"menu/art/settings_0ru"
#define SETTINGS1RU				"menu/art/settings_1ru"
#define DEMOS0RU				"menu/art/demos_0ru"
#define DEMOS1RU				"menu/art/demos_1ru"
#define GAMES0RU				"menu/art/games_0ru"
#define GAMES1RU				"menu/art/games_1ru"
#define EXIT0RU				"menu/art/exit_0ru"
#define EXIT1RU				"menu/art/exit_1ru"
...
/*	if(cl_language.integer == 0){
	trap_R_RegisterShaderNoMip( CREATEGAME0 );
	trap_R_RegisterShaderNoMip( CREATEGAME1 );
	trap_R_RegisterShaderNoMip( FINDGAME0 );
	trap_R_RegisterShaderNoMip( FINDGAME1 );
	trap_R_RegisterShaderNoMip( SETTINGS0 );
	trap_R_RegisterShaderNoMip( SETTINGS1 );
	trap_R_RegisterShaderNoMip( DEMOS0 );
	trap_R_RegisterShaderNoMip( DEMOS1 );
	trap_R_RegisterShaderNoMip( GAMES0 );
	trap_R_RegisterShaderNoMip( GAMES1 );
	trap_R_RegisterShaderNoMip( EXIT0 );
	trap_R_RegisterShaderNoMip( EXIT1 );
	}
	if(cl_language.integer == 1){
	trap_R_RegisterShaderNoMip( CREATEGAME0RU );
	trap_R_RegisterShaderNoMip( CREATEGAME1RU );
	trap_R_RegisterShaderNoMip( FINDGAME0RU );
	trap_R_RegisterShaderNoMip( FINDGAME1RU );
	trap_R_RegisterShaderNoMip( SETTINGS0RU );
	trap_R_RegisterShaderNoMip( SETTINGS1RU );
	trap_R_RegisterShaderNoMip( DEMOS0RU );
	trap_R_RegisterShaderNoMip( DEMOS1RU );
	trap_R_RegisterShaderNoMip( GAMES0RU );
	trap_R_RegisterShaderNoMip( GAMES1RU );
	trap_R_RegisterShaderNoMip( EXIT0RU );
	trap_R_RegisterShaderNoMip( EXIT1RU );
	}*/
}
...
/*	// add the model
	...
	if (uis.demoversion) {
		...
		//if (uis.debug) {
		UI_DrawString( 320, 5, "QSandbox v2024.02.12", UI_CENTER|UI_SMALLFONT, color );
		//}
...
#endif
/*if(cl_language.integer == 0){
	s_main.setup.generic.name		= SETTINGS0;
	s_main.setup.focuspic			= SETTINGS1;
	s_main.demos.generic.name		= DEMOS0;
	s_main.demos.focuspic			= DEMOS1;
	s_main.mods.generic.name		= GAMES0;
	s_main.mods.focuspic			= GAMES1;
	s_main.exit.generic.name		= EXIT0;
	s_main.exit.focuspic			= EXIT1;
}
if(cl_language.integer == 1){
	s_main.setup.generic.name		= SETTINGS0RU;
	s_main.setup.focuspic			= SETTINGS1RU;
	s_main.demos.generic.name		= DEMOS0RU;
	s_main.demos.focuspic			= DEMOS1RU;
	s_main.mods.generic.name		= GAMES0RU;
	s_main.mods.focuspic			= GAMES1RU;
	s_main.exit.generic.name		= EXIT0RU;
	s_main.exit.focuspic			= EXIT1RU;
}*/
