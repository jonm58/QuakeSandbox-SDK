...
static void UI_SaveConfigMenu_SavenameDraw( void *self ) {
	...
	if(cl_language.integer == 0){
	UI_DrawString( 320, FILENAME_Y - 36, "Enter filename:", UI_CENTER|UI_SMALLFONT, color_orange );
	}
	if(cl_language.integer == 1){
	UI_DrawString( 320, FILENAME_Y - 36, "Введите имя файла:", UI_CENTER|UI_SMALLFONT, color_orange );
	}
