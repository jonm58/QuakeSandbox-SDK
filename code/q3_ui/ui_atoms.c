...
if ( Q_stricmp (UI_Argv(0), "mgui_init") == 0 ) {
	for ( i = 1; i < 99; i++ ) {
	trap_Cmd_ExecuteText( EXEC_INSERT, va("unset mitem%i_type\n", i));
	trap_Cmd_ExecuteText( EXEC_INSERT, va("unset mitem%i_x\n", i));
	trap_Cmd_ExecuteText( EXEC_INSERT, va("unset mitem%i_y\n", i));
	trap_Cmd_ExecuteText( EXEC_INSERT, va("unset mitem%i_w\n", i));
	trap_Cmd_ExecuteText( EXEC_INSERT, va("unset mitem%i_h\n", i));
	}
	return qtrue;
}
