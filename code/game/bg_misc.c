...
/*QUAKED weapon_brick (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_brick",
		"sound/misc/w_pkup.wav",
        { "models/swep/block01/weapmdl.md3", 
		"", "", ""},
/* icon */		"brick",
/* icon */		"",
/* icon */		"",
...
/*QUAKED weapon_diamond (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_diamond",
		"sound/misc/w_pkup.wav",
        { "models/swep/block02/weapmdl.md3", 
		"", "", ""},
/* icon */		"diamond_block",
/* icon */		"",
/* icon */		"",
...
/*QUAKED weapon_dirt (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_dirt",
		"sound/misc/w_pkup.wav",
        { "models/swep/block03/weapmdl.md3", 
		"", "", ""},
/* icon */		"dirt",
/* icon */		"",
/* icon */		"",
...
/*QUAKED weapon_stone (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_stone",
		"sound/misc/w_pkup.wav",
        { "models/swep/block04/weapmdl.md3", 
		"", "", ""},
/* icon */		"stone",
/* icon */		"",
/* icon */		"",
...
/*QUAKED weapon_bedrock (.3 .3 1) (-16 -16 -16) (16 16 16) suspended
*/
	{
		"weapon_bedrock",
		"sound/misc/w_pkup.wav",
        { "models/swep/block05/weapmdl.md3", 
		"", "", ""},
/* icon */		"bedrock",
/* icon */		"",
/* icon */		"",
...
gitem_t	*BG_FindSwep( int id ) {
	...
	for ( it = bg_itemlist + 1 ; it->classname ; it++ ) {
		if ( it->giType == IT_WEAPON && it->swep_id == id ) {
			return it;
		}
	}
