...
gentity_t *fire_new (gentity_t *self, vec3_t start, vec3_t aimdir);
gentity_t *fire_new2 (gentity_t *self, vec3_t start, vec3_t aimdir);
gentity_t *fire_new3 (gentity_t *self, vec3_t start, vec3_t aimdir);
gentity_t *fire_new4 (gentity_t *self, vec3_t start, vec3_t aimdir);
gentity_t *fire_new5 (gentity_t *self, vec3_t start, vec3_t aimdir);
